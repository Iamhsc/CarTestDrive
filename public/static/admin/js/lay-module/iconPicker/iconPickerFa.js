            ...
            createList: function (text) {
                ...
                if (page) {
                    ...
                    pageHtml = '<div class="layui-iconpicker-page" id="' + PAGE_ID + '">' +
                        ...
                        '<i class="layui-icon" id="' + PAGE_ID + '-prev" data-home="0" prev>&#xe603;</i> ' +
                        '<i class="layui-icon" id="' + PAGE_ID + '-next" data-home="2" next>&#xe602;</i> ' +
                        '</div>' +
                        '</div>';
                }
            ...
            page: function () {
                ...
                a.event('click', icon, function (e) {
                    var elem = e.currentTarget,
                        ...
                        // 按钮上标的页码
                        index = parseInt($(elem).attr('data-home')),
                        $cur = $('#' + PAGE_ID + '-current'),
                        // 点击时正在显示的页码
                    ...
                    if (isPrev && current > 1) {
                        current = current - 1;
                        $(icon + '[prev]').attr('data-home', current);
                    } else if (!isPrev && current < total) {
                        current = current + 1;
                        $(icon + '[next]').attr('data-home', current);
                    }
                    $cur.html(current);
