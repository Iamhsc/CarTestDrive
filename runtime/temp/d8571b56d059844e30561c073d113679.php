<?php /*a:1:{s:67:"/vagrant/phpwebsite/CarTestDrive/application/admin/view/manager/index.html";i:1573060150;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="layui-fluid">
    <div class="layui-card">
        ...
        <div class="layui-card-body">
            <?php if((buttonAuth('manager/addadmin'))): ?>
            ...
            <script type="text/html" id="table-seller-admin">
                <?php if((buttonAuth('manager/editadmin'))): ?>
                <a class="layui-btn layui-btn-normal layui-btn-xs" lay-event="edit"><i class="layui-icon layui-icon-edit"></i>编辑</a>
                <?php endif; if((buttonAuth('manager/deladmin'))): ?>
                {{#  if(d.admin_id == '1'){ }}
...
<script>
    layui.config({
        ...
        var active = {
            ...
            add: function() {
                layTool.open( "<?php echo url('manager/addAdmin'); ?>", "添加管理员", '50%', '50%');
            }
        };
                    ...
                    if ("del" === e.event) {
                        ...
                        layer.ready(function () {
                            var index = layer.confirm('您确定要删除该管理员？', {
                                ...
                                $.getJSON('<?php echo url("manager/delAdmin"); ?>', {id: e.data.admin_id}, function (res) {
