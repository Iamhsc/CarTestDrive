<?php /*a:1:{s:70:"/vagrant/phpwebsite/CarTestDrive/application/admin/view/car/index.html";i:1573978236;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div class="layui-card">
        ...
        <div class="layui-card-body">
            ...
            <script type="text/html" id="table-seller-car-car-model">
                <?php if((buttonAuth('car/edit'))): ?>
                <a class="layui-btn layui-btn-normal layui-btn-xs" lay-event="edit"><i
                        class="layui-icon layui-icon-edit"></i>编辑</a>
                <?php endif; if((buttonAuth('car/del'))): ?>
...
<script>
    layui.config({
        ...
        var active = {
            add: function () {
                layTool.open("<?php echo url('car/add'); ?>", "添加车辆型号", '50%', '50%');
            }
        };
                    ...
                    if ("del" === e.event) {
                        ...
                        layer.ready(function () {
                            var index = layer.confirm('您确定要删除该型号？', {
                                ...
                                $.getJSON('<?php echo url("car/del"); ?>', {id: e.data.car_model_id}, function (res) {
                                    if (0 == res.code) {
                                        layer.msg(res.msg);
                                        setTimeout(function () {
                                            renderTable();
